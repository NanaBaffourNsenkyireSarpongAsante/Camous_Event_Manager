                ...
                <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8fafc;border-radius:12px;overflow:hidden;">
                    <div style="background:#1e3a8a;padding:32px 24px;text-align:center;">
                        <div style="display:inline-flex;align-items:center;gap:12px;">
                            <img src="https://th.bing.com/th/id/R.6d634fffb880acc7313e962fb3c1bdfd?rik=Y%2bTjwLY3kvg%2fcQ&pid=ImgRaw&r=0" alt="KEM Logo" style="width:48px;height:48px;border-radius:50%;object-fit:cover;background:white;padding:3px;">
                    ...
                    <div style="padding:32px 24px;">
                        ...
                        <p style="color:#6b7280;font-size:0.85rem;margin-top:32px;">This is an automated message from KEM – Campus Event Manager. Please do not reply.</p>
                    </div>
                </div>
            `,
